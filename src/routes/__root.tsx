...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MT 24 Horas Express — Entregador & Motorista" },
      { name: "description", content: "Aplicativo oficial de entregadores e motoristas parceiros do MT 24 Horas Express." },
      { name: "author", content: "MT 24 Horas Express" },
      { property: "og:title", content: "MT 24 Horas Express — Entregador & Motorista" },
      { property: "og:description", content: "Aplicativo oficial de entregadores e motoristas parceiros do MT 24 Horas Express." },
      ...
      { name: "twitter:title", content: "MT 24 Horas Express — Entregador & Motorista" },
      { name: "twitter:description", content: "Aplicativo oficial de entregadores e motoristas parceiros do MT 24 Horas Express." },
